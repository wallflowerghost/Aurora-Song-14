...
public sealed partial class GeneralRecord : Control
{
    ...
    public GeneralRecord(GeneralStationRecord record, bool canDelete, uint? id, IPrototypeManager prototypeManager)
    {
        ...
        if (record.Replicant) // AS: Replika
            species = Loc.GetString("species-name-replicant", ("species", species)); // AS: Replika
        Species.Text = Loc.GetString("general-station-record-console-record-species", ("species", species)); // AS: Replika
