    ...
    public void UpdateTabMerging()
    {
        ...
        string GetDirection(Direction direction, int position)
        {
            return position switch
            {
                ...
                0 => direction switch
                {
                    North => StyleClass.ButtonOpenRight,
                    South => StyleClass.ButtonOpenRight,
                    East => StyleClass.ButtonOpenLeft,
                    West => StyleClass.ButtonOpenLeft,
                    _ => StyleClass.ButtonOpenRight,
                },
                // Middle
                1 => StyleClass.ButtonOpenBoth,
                // Last
                2 => direction switch
                {
                    North => StyleClass.ButtonOpenLeft,
                    South => StyleClass.ButtonOpenLeft,
                    East => StyleClass.ButtonOpenRight,
                    West => StyleClass.ButtonOpenRight,
                    _ => StyleClass.ButtonOpenLeft,
                },
