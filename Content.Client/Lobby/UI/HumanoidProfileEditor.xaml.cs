...
using Content.Shared.Dataset; // Aurora's Song
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        public void RefreshFlavorText()
        {
            if (_allowFlavorText)
            {
                ...
                TabContainer.SetTabTitle(4, Loc.GetString("humanoid-profile-editor-flavortext-tab")); // TheDen
            }
            else
            {
                if (_flavorText == null)
        ...
        public void SetProfile(HumanoidCharacterProfile? profile, int? slot)
        {
            ...
            UpdateHeightControls(); // Aurora's Song
            UpdateWidthControls(); // Aurora's Song
            UpdateAgeEdit();
            UpdateEyePickers();
            UpdateSaveButton();
            UpdateMarkings();
