...
public abstract partial class SharedGunSystem : EntitySystem
{
    ...
    private bool AttemptShoot(EntityUid user, Entity<GunComponent> gun)
    {
        ...
        // Remove ammo
        var ev = new TakeAmmoEvent(shots, [], fromCoordinates, user, true); // Frontier: add intent to fire
    ...
    public void CauseImpulse(EntityCoordinates fromCoordinates, EntityCoordinates toCoordinates, Entity<PhysicsComponent> user)
    {
        ...
        // End Frontier
        // Physics.ApplyLinearImpulse(user, -impulseVector, body: user.Comp); // Frontier: old implementation
    }
