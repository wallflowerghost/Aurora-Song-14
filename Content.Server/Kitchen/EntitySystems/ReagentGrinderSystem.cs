...
namespace Content.Server.Kitchen.EntitySystems
{
    ...
    internal sealed class ReagentGrinderSystem : SharedReagentGrinderSystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<ReagentGrinderComponent, RefreshPartsEvent>(OnRefreshParts); // Frontier
            SubscribeLocalEvent<ReagentGrinderComponent, UpgradeExamineEvent>(OnUpgradeExamine); // Frontier
