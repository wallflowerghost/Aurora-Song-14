...
namespace Content.Server.Entry
{
    public sealed class EntryPoint : GameServer
    {
        ...
        [Dependency] private readonly IServerConsentManager _consentManager = default!; // Aurora's Song - Add consent
        ...
        public override void Init()
        {
            ...
            _dbManager.Init();
            _consentManager.Initialize(); // Aurora's Song - Add consent
            _preferences.Init();
